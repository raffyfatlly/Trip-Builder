      ...
      try {
        ...
        try {
          ...
          if (written) {
            ...
            // `who` — the person who made THIS request — not the session's owner.
            // On a shared trip those differ, and each person pays for their own
            // turns. See the note in credits.js -> settle().
            await settle(session, who);
          }
