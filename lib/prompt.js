...
- a trip that gets LONGER or SHORTER. Moving the same trip to different dates is \`shift_dates\`, not this — and it is free.
- a hotel in a DIFFERENT TOWN, or one that moves which part of the trip they are in — the distances and what is nearby genuinely change. A different hotel in the same area is \`update_stay\`, not this.
