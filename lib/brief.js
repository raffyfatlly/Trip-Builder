  ...
  input_schema: {
    ...
    properties: {
      ...
      confirmed: {
        type: 'boolean',
        description:
          'REQUIRED, and must be true, for any build after the first one. A rebuild takes minutes and costs'
          + ' them real credits, so it does not start without their yes — the app refuses the call and tells'
          + ' you what to say. Ask them first, in your own words, then call again with confirmed=true.'
          + ' Leave it out on the first build of a trip; there is nothing to lose and nothing to confirm.',
      },
