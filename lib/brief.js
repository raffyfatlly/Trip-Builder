...
export const BUILD_TOOL = {
  ...
  description:
    'Hand the trip over to the itinerary builder. Call this at the END of planning, once note_plan shows nothing important still open — or straight away if the traveller asks you to build. A build takes minutes and costs real money, so it is worth being right the first time. The builder does all the research and writing; your job is to give it a brief so good it never has to guess. Call it again later only if the traveller changes something structural.',
  input_schema: {
    type: 'object',
    properties: {
