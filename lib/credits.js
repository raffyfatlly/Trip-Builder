...
//    add it to 10."
//
// 10 buys three or four turns — the onboarding, a set of photo cards, and a
// follow-up — which is enough to see what the thing actually does. What it
// costs us is exactly 10 x RM0.10 = RM1.00 per signup, and only if they spend
// every credit.
//
...
export const grant = () => num('CREDIT_GRANT', 'creditGrant', 10);
