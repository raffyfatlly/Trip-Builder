// The landing page's free question — one real answer, no interview.
//
...
// landing page to ask for free. one question... i want it too look real nice.
// really focus on this section... the agent must answer it nicely and really
...
// one question from a stranger. It is a single direct call to the Messages
// API with a system prompt that forbids asking anything back, the same fact
...
// by design, one question per visitor or not, per askHook below. web_search
// answers "what does it cost" well enough for a first taste; the metered
// tools are for someone who has already committed to building a trip.
...
const SYSTEM = `You are the trip-planning desk a traveller hits the moment they land on this site — before they have signed up for anything. They have one free question, typed the way someone types into a Facebook group asking strangers for advice.
