...
export async function hotelHostProbe() {
  ...
  const t = token();
  const tries = [
    ['engine lookup', 'https://engine.hotellook.com/api/v2/lookup.json?query=Kuching&lang=en&lookFor=city&limit=1&token=' + t],
    ['engine cache', 'https://engine.hotellook.com/api/v2/cache.json?location=Kuching&checkIn=2026-10-14&checkOut=2026-10-17&currency=myr&limit=3&token=' + t],
    ['yasen lookup', 'https://yasen.hotellook.com/lookup.json?query=Kuching&lang=en&lookFor=city&limit=1&token=' + t],
    ['yasen cache', 'https://yasen.hotellook.com/cache.json?location=Kuching&checkIn=2026-10-14&checkOut=2026-10-17&currency=myr&limit=3&token=' + t],
    ['tp hotel lookup', 'https://api.travelpayouts.com/hotels/lookup?query=Kuching&lang=en&lookFor=city&limit=1&token=' + t],
    ['tp hotel cache', 'https://api.travelpayouts.com/hotels/cache?location=Kuching&checkIn=2026-10-14&checkOut=2026-10-17&currency=myr&limit=3&token=' + t],
    ['hotellook v2 cache', 'https://hotellook.com/api/v2/cache.json?location=Kuching&checkIn=2026-10-14&checkOut=2026-10-17&currency=myr&limit=3&token=' + t],
  ];
  const out = {};
