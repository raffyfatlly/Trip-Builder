        ...
        items: {
          ...
          properties: {
            ...
            rating: {
              type: 'string',
              description:
                'What people actually score it, with the source and the count: "4.6 on Google, 2,300 reviews", "8.9 on Booking". This is the first thing a traveller looks for, so look it up and put it here. Leave it out rather than guessing — "rating not found" is fine, an invented 4.5 is not.',
            },
            ...
            link: { type: 'string', description: "The place's own website or booking page, if your research turned one up. Give it whenever you have it — a map link is added automatically, but their own page is what someone actually wants to open. Never invent a URL." },
          },
          required: ['name', 'why'],
        },
      },
      ...
      spots: {
        ...
        items: {
          ...
          properties: {
            ...
            tags: { type: 'array', items: { type: 'string' } },
            link: { type: 'string', description: "The place's own page, if your research turned one up. A map link is added automatically. Never invent a URL." },
          },
          required: ['name', 'buzz'],
        },
      },
