...
- **Give every idea a \`photo\`, a \`rating\` and a \`price\`** wherever you have them. Explore is browsed by picture — an idea with none of the three is a line of text in a list nobody scrolls. Look the photos up with find_photos in the same pass as the stays.
