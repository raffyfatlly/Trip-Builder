...
export function render(T, templateSrc) {
  ...
  insertBefore('</style>', [
    ...
    '  .tdfoot{display:flex;align-items:center;gap:12px;margin-top:13px;',
    '    padding:11px 0 0;border-top:1px solid var(--line)}',
    '  .tdgo{display:flex;align-items:center;justify-content:space-between;gap:8px;flex:1;min-width:0;',
  ...
  const BOOKINGS_JS = [
    ...
    '    h+=\'</div></div>\';',
    '    var foot="";',
    '    if(t.link) foot+=\'<a class="tdgo" href="\'+esc(t.link)+\'" target="_blank" rel="noopener noreferrer">\'+',
    ...
    '    // Telling the app you have done it, without leaving the list you are',
    '    // working from.',
    '    //',
    '    // raffy, 2026-09-01: "the only way is for user to confirm via chat, so',
    '    // user need to navigate back to chat on different page (in mobile ) and',
    '    // have to keep referring to the still to do section right."',
    '    //',
