...
export const CARDS_RULE =
  'House rule, every turn: the FIRST time you name places in this conversation'
  + ' — hotels, restaurants, activities, attractions, areas — send them through'
  + ' `present` as cards with photos, not as prose or a bulleted list, and do it'
  + ' without being asked to "give options". Two or more of anything means a card'
  + ' set. Once a set is on screen, talking about those same places afterwards is'
