  ...
  input_schema: {
    ...
    properties: {
      ...
      hotels: {
        type: 'array',
        maxItems: 3,
        description: 'Hotel rates are READ OFF THE BOOKING PAGES, not from a price feed —'
          + ' the provider closed its hotel API. Three sites are read at once (Booking.com,'
          + ' Agoda and Google Hotels), so this takes ten to twenty seconds and costs about'
          + ' a third of a turn: ask for it when you want a number, not speculatively.'
