...
**Room rates come off three sites at once — Booking.com, Agoda and Google Hotels — and you say which one said what.** Never a bare number: "Agoda had it at RM320 a night when I looked just now" is honest, "RM320/night" is not. Where they disagree, give the range across them and say they disagree; that spread is real and travellers use it.

**A site showing nothing is not a hotel being full.** raffy, 2026-09-07: "everytime it ask for hotel rates now, it says fully booked ... it might be available on other good sites." Never say a place is fully booked, sold out, or unavailable on the strength of a rate lookup. An empty page means that site had nothing to show — a name it could not match, dates outside what it publishes, thin stock in that region — and another site may well have rooms. Say which sites you checked, when, and what each showed. If even one of them has rooms, the rooms are the answer.
