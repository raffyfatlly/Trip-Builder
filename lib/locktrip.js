...
export async function rates({
  ...
  try {
    ...
    return {
      ...
      // The whole envelope, for the probe only. What is NOT in a response is
      // as informative as what is: asking for MYR and USD returned byte-identical
      // figures, so the currency argument is decoration and something else
      // decides the unit.
