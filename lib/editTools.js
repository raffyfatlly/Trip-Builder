    ...
    properties: {
      ops: {
        ...
        items: {
          type: 'object',
          properties: {
            op: { type: 'string', enum: ['update', 'delete', 'add', 'confirm_stay', 'save_booking', 'add_task', 'tick_task'] },
            ...
            id: { type: 'string', description: 'Item id from read_itinerary (for update/delete), or the task id (for tick_task). For add_task it is optional — pass "d:flights" to fill in the flight row already on their list instead of adding another.' },
          },
          required: ['op'],
        },
      },
