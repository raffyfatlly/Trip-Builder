...
export const CHAT_TOOLS = () => [
  ...
  RESEARCH_TOOL,
  // raffy, 2026-09-14: loved editing the finished app from chat, then asked
  // for a photo to be added to it and nothing happened — the agent said "the
  // app will pull the hotel's photo automatically", which is not a real
  // mechanism. find_photos already exists and already works (the builder has
  // used it since the start); it was just never given to chat, and even if it
  // had been, edit_itinerary had no op to attach what it found. set_photo
  // above closes the second half; this closes the first.
  FIND_TOOL,
